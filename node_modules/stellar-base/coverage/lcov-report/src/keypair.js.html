...
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid Stellar accountId');</span>
    }
...
<span class="cstat-no" title="statement not covered" >    return new xdr.PublicKey.keyTypeEd25519(this._publicKey);</span>
  }
&nbsp;
  /**
...
&nbsp;
   ...
   * @returns {Buffer}
   */
  rawSeed<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return this._secretSeed;</span>
  }
&nbsp;
  /**
   ...
   * @returns {Buffer}
   */
  rawSecretKey<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return this._secretKey;</span>
  }
&nbsp;
  /**
