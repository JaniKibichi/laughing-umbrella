...
&nbsp;
     ...
     */
    transaction<span class="fstat-no" title="function not covered" >(transactionId) {</span>
<span class="cstat-no" title="statement not covered" >        this.filter.push(['transactions', transactionId]);</span>
...
&nbsp;
     ...
     * @returns {TransactionCallBuilder}
     */
    forAccount<span class="fstat-no" title="function not covered" >(accountId) {</span>
<span class="cstat-no" title="statement not covered" >        this.filter.push(['accounts', accountId, 'transactions']);</span>
<span class="cstat-no" title="statement not covered" >        return this;</span>
    }
&nbsp;
    /**
