...
<span class="cstat-no" title="statement not covered" >        if (response instanceof Error) {</span>
<span class="cstat-no" title="statement not covered" >          return Promise.reject(response);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          return Promise.reject(response.data);</span>
        }
      });
  }
}
