...
<div class='wrapper'>
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y'>
        <span class="strong">4 statements, 5 branches</span>
...
&nbsp;
  ...
  _requestFnForLink(link) {
    return <span class="fstat-no" title="function not covered" >opts =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      let uri;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (link.template) {</span>
<span class="cstat-no" title="statement not covered" >        let template = URITemplate(link.href);</span>
<span class="cstat-no" title="statement not covered" >        uri = URI(template.expand(opts));</span>
      } else {
<span class="cstat-no" title="statement not covered" >        uri = URI(link.href);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this._sendNormalRequest(uri).then(<span class="fstat-no" title="function not covered" >r </span>=&gt; this._parseRecord(r));</span>
    };
  } 
&nbsp;
  /**
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Jul 08 2016 15:37:57 GMT+0000 (UTC)
</div>
</div>
